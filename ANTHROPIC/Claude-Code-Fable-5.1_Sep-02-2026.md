<!--
Claude Code (Fable 5.1) - interactive
...
assembled at runtime on one machine.
  ...
  reproduce:  node capture/capture.mjs claude --model claude-fable-5-1
  tool:       OrcaReplay, Apache-2.0 - https://github.com/Continuum-AI-Corp/OrcaReplay
  public copy: https://github.com/Continuum-AI-Corp/OrcaReplay/blob/main/prompt/CLAUDECODE/claude-fable-5-1-system-prompt.md
  as sent:    Claude Code CLI v2.1.258.18d, interactive TTY, 26,463 chars, 35 tools
