<!--
Claude Code (Opus 5) - interactive
...
assembled at runtime on one machine.
  ...
  reproduce:  node capture/capture.mjs claude --model claude-opus-5
  tool:       OrcaReplay, Apache-2.0 - https://github.com/Continuum-AI-Corp/OrcaReplay
  public copy: https://github.com/Continuum-AI-Corp/OrcaReplay/blob/main/prompt/CLAUDECODE/claude-opus-5-system-prompt.md
  as sent:    Claude Code CLI v2.1.258.18d, interactive TTY, 22,760 chars, 35 tools
