<!--
opencode - apply_patch template (model: gpt-5.6-sol via a self-hosted gateway)
...
assembled at runtime on one machine.
  ...
  reproduce:  node capture/capture.mjs opencode --model gpt-5.6-sol
  tool:       OrcaReplay, Apache-2.0 - https://github.com/Continuum-AI-Corp/OrcaReplay
  public copy: https://github.com/Continuum-AI-Corp/OrcaReplay/blob/main/prompt/OPENCODE/gpt-5-6-sol-system-prompt.md
  as sent:    opencode run mode, 10,413 chars, 9 tools; the only one of seven carrying apply_patch instead of edit/write
