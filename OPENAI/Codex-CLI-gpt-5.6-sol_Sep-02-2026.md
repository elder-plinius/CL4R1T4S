...
assembled at runtime on one machine.
  ...
  reproduce:  node capture/capture.mjs codex --model gpt-5.6-sol
  tool:       OrcaReplay, Apache-2.0 - https://github.com/Continuum-AI-Corp/OrcaReplay
  public copy: https://github.com/Continuum-AI-Corp/OrcaReplay/blob/main/prompt/CODEX/gpt-5-6-sol-system-prompt.md
  as sent:    Codex CLI exec mode, Responses API dialect, 23,377 chars, 9 tools
...
- skill-creator: Create or update a Codex skill with appropriately scoped instructions and any needed supporting resources. (file: {{CODEX_HOME}}/skills/.system/skill-creator/SKILL.md)
